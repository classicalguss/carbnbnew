	...
	<div class="row">
		...
		<div class="col-sm-8">
			<div class="sign-forms">
				...
				<a target="_blank" href="/user/auth?authclient=facebook" title="Facebook" data-popup-width="860" data-popup-height="480" class="facebook auth-link btn btn-block btn-lg btn-facebook"> <i class="fa fa-facebook"></i> Connect with Facebook </a>
			</div>
		</div>
	</div>
</div>
