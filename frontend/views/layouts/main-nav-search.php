				...
				<div class="col-md-7">
					<div class="view-search-bar">
						<form class="" action="" method="get">
							<div class="clearfix">
								<div class="no-gutter col col-md-6">
									<div class="form-group border-right">
										<input type="search" class="form-control no-border" id="search-where" name="location" placeholder="Dubai - United Arab Emirates">
									</div>
								</div>
								<div class="no-gutter col col-md-6">
									<div class="form-group">
										<input type="text" class="form-control no-border" id="search-when" name="daterange" placeholder="Pick date">
									</div>
								</div>
							</div>
						</form>
